...
map.getView().fit([12283442.564860, -874925.462898, 12293172.261817, -869146.823560], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lokasi Pembuatan Sumur Resapan Kota Yogyakarta Tahun 2023</h2>';
        return titleElement;
    })(),
